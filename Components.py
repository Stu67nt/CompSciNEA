...
class TimerCreate(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.hours_spinbox = tk.Spinbox(self, from_=0, to=23, repeatdelay=500, repeatinterval=100,
                     font=("Arial", 20))
        self.hours_spinbox.grid(row=1, column=1, padx=10, pady=(10, 10), sticky="ne")
        ...
        self.mins_spinbox = tk.Spinbox(self, from_=0, to=59, repeatdelay=500, repeatinterval=100,
                     font=("Arial", 20))
        self.mins_spinbox.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="ne")
        ...
        self.secs_spinbox = tk.Spinbox(self, from_=0, to=59, repeatdelay=500, repeatinterval=100,
                     font=("Arial", 20))
        self.secs_spinbox.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="ne")


        self.button = ButtonFrame(self, self.BUTTON, is_horizontal = True, button_sticky = "nw")
        self.button.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="nsw")
